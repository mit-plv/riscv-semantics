...
data MMIO32 = MMIO32 { registers :: [Int32], pc :: Int32, nextPC :: Int32, mem :: [Word8], mmio :: [(LoadFunc, StoreFunc)], input :: String, output :: String }
                deriving (Show)

type LoadFunc = MMIO32 -> (Int32, MMIO32)
type StoreFunc = MMIO32 -> Int32 -> MMIO32
