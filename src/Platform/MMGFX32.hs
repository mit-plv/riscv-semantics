...
data MMGFX32 = MMGFX32 { registers :: [Int32], csrs :: [(Int, CSR)], pc :: Int32, nextPC :: Int32, mem :: [Word8], mmio :: [(LoadFunc, StoreFunc)] }
              deriving (Show)

-- open, close, read, write

type LoadFunc = MState MMGFX32 Int32
type StoreFunc = Int32 -> MState MMGFX32 ()
...
bytesPerPixel = 1
screenBytes :: Int
screenBytes = bytesPerPixel * screenWidth * screenHeight

instance RiscvProgram (MState MMGFX32) Int32 Word32 where
