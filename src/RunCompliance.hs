    ...
    do
      ...
      case beginSignature of
        ...
        Just beginSignature -> do
           ...
           let signature = fmap  (M.loadWord (Minimal32.mem finalState :: MapMemory Int )) [i | i <- [(fromIntegral beginSignature :: Int) .. endSignature] , (i `mod` 4) == 0 ]
